...
from src.Board import BOARD_START, DIE_SIZE, P1LOGICALOFF, P2LOGICALOFF, Board, P1BAR,P2BAR,P1OFF,P2OFF
...
class Game:
    ...
    def _play(self):
        ...
        while True:
            ...
            die1 = self.random(1,DIE_SIZE)
            die2 = self.random(1,DIE_SIZE)
            ...
            start = time()
            ms = playerAgent.make_move(self._player_board, die1, die2, self.turn, opponentMove)
            end = time()
            ...
            if self.is_valid_move_sequence(ms, die1, die2):
    ...
    def is_valid_move_sequence(self, ms, die1, die2):
        return True
